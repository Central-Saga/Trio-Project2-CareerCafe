...
export default function ProfilePage() {
  ...
  const handleProfileImageChange = async (
    ...
    try {
      const compressedImage = await compressImage(file, 500, 500, 0.85);
      ...
      setMessage("Gagal memproses foto profil.");
    }
  ...
  const handleCoverImageChange = async (
    ...
    try {
      const compressedImage = await compressImage(file, 1600, 700, 0.85);

      localStorage.setItem("cover_image", compressedImage);

      setCoverImage(compressedImage);

      showMessage("Background profil berhasil diperbarui.");
    } catch {
      setMessage("Gagal memproses background profil.");
    }
  ...
  const removeProfileImage = () => {
    ...
    showMessage("Foto profil dihapus.");
  };
  ...
  const removeCoverImage = () => {
    ...
    showMessage("Background profil dihapus.");
  };
      ...
      <section className="mx-auto max-w-6xl px-6 py-10 md:px-8">
        ...
        <section className="overflow-hidden rounded-3xl border border-[#E9E3D7] bg-white shadow-sm">
          ...
          <div className="relative h-52 overflow-hidden">
            ...
            {/* Cover actions - hanya muncul saat edit */}
            {isEditing && (
              <>
                <div className="absolute right-4 top-4 z-10 flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="flex h-10 w-10 cursor-pointer items-center justify-center rounded-full bg-white/95 text-[#1E3F20] shadow-md transition hover:scale-105 hover:bg-white"
                  ...
                  {coverImage && (
                    <button
                      ...
                      className="flex h-10 w-10 cursor-pointer items-center justify-center rounded-full bg-white/95 text-[#6B6259] shadow-md transition hover:scale-105 hover:bg-[#F8F6F1] hover:text-[#1E3F20]"
            ...
            <div className="flex flex-col gap-6 md:flex-row md:items-center">
              ...
              <div className="-mt-14 flex-shrink-0">
                <div className="relative">
                  ...
                  {/* Avatar actions - hanya muncul saat edit */}
                  {isEditing && (
                    <>
                      <div className="absolute -bottom-1 -right-1 flex items-center gap-1">
                        ...
                        <button
                          ...
                          className="flex h-10 w-10 cursor-pointer items-center justify-center rounded-full border-4 border-white bg-[#1E3F20] text-white shadow-md transition hover:scale-105 hover:bg-[#152e17]"
                        ...
                        {profileImage && (
                          <button
                            ...
                            className="flex h-10 w-10 cursor-pointer items-center justify-center rounded-full border-4 border-white bg-white text-[#6B6259] shadow-md transition hover:scale-105 hover:bg-[#F8F6F1] hover:text-[#1E3F20]"
        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-[1.5fr_1fr]">
          ...
          <section className="rounded-3xl border border-[#E9E3D7] bg-white p-6 shadow-sm md:p-8">
            <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              ...
              {/* Satu-satunya tombol Edit Profil */}
              {!isEditing && (
                <button
                  type="button"
          ...
          <aside className="space-y-6">
            ...
            <section className="rounded-3xl border border-[#E9E3D7] bg-white p-6 shadow-sm">
              ...
              <div className="mt-5 space-y-3">
                ...
                <div className="flex items-center justify-between rounded-2xl bg-[#F8F6F1] p-4">
                  <div>
                    <p className="text-sm font-bold text-[#2C1E16]">Jadwal</p>
                ...
                <div className="flex items-center justify-between rounded-2xl bg-[#F8F6F1] p-4">
                  <div>
                    <p className="text-sm font-bold text-[#2C1E16]">Lamaran</p>
            ...
            <section className="rounded-3xl bg-[#1E3F20] p-6 text-white shadow-sm">
              ...
              <p className="mt-2 text-sm leading-6 text-white/75">
                Temukan mentor, jadwalkan konsultasi, dan kembangkan kemampuanmu
